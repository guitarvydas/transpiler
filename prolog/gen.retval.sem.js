_ = {
    retstack: [0],
    clearret: function () {
	console.error (`clearret ${_.retstack}`);
	_.retstack = [0];
    },
    rettop: function () {
	let top = _.retstack.pop ();
	_.retstack.push (top);
	console.error (`rettop ${_.retstack}`);
	return `_${top}`;
    },
    retpop: function () {
	let top = _.retstack.pop ();
	console.error (`retpop ${_.retstack}`);
	return `_${top}`;
    },
    retprev: function () {
	let top = _.retstack.pop ();
	...
	_.retstack.push (top);
	console.error (`retprev ${_.retstack}`);
	return `_${next}`;
    },
    retnew: function () {
	let top = _.retstack.pop ();
	...
	console.error (`retnew ${_.retstack}`);
    }
},
