...
string: function (ldq,strchar,rdq) {
_ruleEnter ("string");
ldq = ldq.rwr ();
strchar = strchar.rwr ().join ('');
rdq = rdq.rwr ();

_ruleExit ("string");
return `${ldq}${strchar}${rdq}`;
},
strchar_space: function (c) {
_ruleEnter ("strchar_space");
c = c.rwr ();

_ruleExit ("strchar_space");
return `${◦}`;
},
strchar_nl: function (c) {
_ruleEnter ("strchar_nl");
c = c.rwr ();

_ruleExit ("strchar_nl");
return `${▿}`;
},
strchar_tab: function (c) {
_ruleEnter ("strchar_tab");
c = c.rwr ();

_ruleExit ("strchar_tab");
return `${▹}`;
},
strchar_any: function (c) {
_ruleEnter ("strchar_any");
c = c.rwr ();

_ruleExit ("strchar_any");
return `${c}`;
},
